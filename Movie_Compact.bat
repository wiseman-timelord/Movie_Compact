...
:main_menu
cls
call :printHeader "Movie_Compact"
echo.
echo.
echo     1. Run Movie_Compact
echo.
...
echo.
call :printSeparator
set /p choice=Selection; Menu Options = 1-2, Exit MovieCompact = X: 

if "!choice!"=="1" (
    goto run_launcher
    echo Selected: Run MovieCompact
    timeout /t 1 >nul
) else if "!choice!"=="2" (
    ...
    echo Selected: Exit MovieCompact
    timeout /t 1 >nul
    goto :end_of_file
) else (
...
:end_of_file
cls
call :printHeader "Exit MovieCompact"
echo.
timeout /t 1 >nul
echo Exiting MovieCompact
timeout /t 1 >nul
